...
const features = [
  ...
  },
  {
    ...
    description: 'Fetch and review pull requests',
    icon: (
    ...
    color: 'bg-gray-800',
    path: '/github',
    endpoint: '/pull-requests/count'
  },
  {
    id: 'teams',
    title: 'Teams',
    description: 'Manage review teams and members',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 'assignments',
    title: 'Assignments',
    description: 'Track review assignments',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    color: 'bg-violet-500',
    path: '/assignments',
    endpoint: '/assignments/count'
  },
  {
    id: 'webhooks',
    title: 'Webhooks',
    description: 'Auto-review on push events',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 'analytics',
    title: 'Analytics',
    description: 'Review metrics and trends',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
      </svg>
